...
const siteData = {
  business: {
    name: "Benevolent Security Services",
    legalName: "Benevolent Security Services",
    tagline: "Professional Security You Can Trust",
    description: "Benevolent Security Services provides comprehensive security solutions including CCTV, alarms, guarding, and consulting. Protecting Harare from our Angwa Street headquarters with professionalism and integrity.",
    phone: "+263 71 564 1827",
    phoneRaw: "+263715641827",
    whatsappNumber: "263715641827",
    email: "info@benevolentsecurity.co.zw",
    address: "5th Floor, Pockets Building Angwa St, Jason Moyo Ave, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "benevolent-security-services-cookie-consent",
    socialLinks: {
      facebook: "#",
      instagram: "#",
      linkedin: "#",
  ...
  navbar: {
    logoImage: null,
    logoLine1: "Benevolent",
    logoLine2: "Security Services",
  },

  hero: {
    badge: "Professional Security Services Since 2016",
    titleParts: [
      { text: "SECURITY" },
      { text: "WITH", highlight: true },
      { text: "INTEGRITY." },
    ],
    subtitle: "Benevolent Security Services provides comprehensive security solutions including CCTV, alarms, guarding, and consulting. Protecting Harare from our Angwa Street headquarters with professionalism and integrity.",
    ctaPrimary: "Request Consultation",
    ctaSecondary: "Our Solutions",
    trustBadge: "600+ Clients Served",
    backgroundImages: [
  ...
  stats: [
    { number: "600+", label: "Installations Done" },
  ...
  homeTestimonials: [
    { text: "Benevolent Security Services installed a complete CCTV system at my home and I finally feel safe. The cameras are crystal clear and I can check my phone from anywhere.", name: "Wellington Moyo", role: "Homeowner, Borrowdale", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "We contracted Benevolent Security Services for our estate security and they delivered a fully integrated system -- cameras, access control, and electric fencing all working together.", name: "Chenai Dziva", role: "Property Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "Benevolent Security Services installed security cameras at our school and the improvement in safety and accountability has been remarkable. Parents are very reassured.", name: "Tapiwa Gondo", role: "School Headmaster", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
    { text: "The alarm system Benevolent Security Services installed has already paid for itself. Fast response, reliable monitoring, and their technicians are always available when needed.", name: "Martha Zvobgo", role: "Business Owner, CBD", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
  ],
  ...
  about: {
    ...
    story: [
      "Benevolent Security Services has been protecting Harare businesses and residences since 2016. From our Angwa Street headquarters, we deploy integrated security solutions backed by trained professionals.",
      "Over 600 clients trust us with their safety because we combine cutting-edge technology with human expertise. Our name reflects our mission -- security delivered with genuine care.",
    ],
    values: [
    ...
    team: [
      { name: "Team Leader", role: "Director", bio: "Leading Benevolent Security Services with expertise and vision.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" },
  ...
  reviews: {
    ...
    items: [
      { text: "Benevolent Security Services installed a complete CCTV system at my home and I finally feel safe. The cameras are crystal clear and I can check my phone from anywhere.", name: "Wellington Moyo", role: "Homeowner, Borrowdale", rating: 5 },
      { text: "We contracted Benevolent Security Services for our estate security and they delivered a fully integrated system -- cameras, access control, and electric fencing all working together.", name: "Chenai Dziva", role: "Property Manager", rating: 5 },
      { text: "Benevolent Security Services installed security cameras at our school and the improvement in safety and accountability has been remarkable. Parents are very reassured.", name: "Tapiwa Gondo", role: "School Headmaster", rating: 5 },
      { text: "The alarm system Benevolent Security Services installed has already paid for itself. Fast response, reliable monitoring, and their technicians are always available when needed.", name: "Martha Zvobgo", role: "Business Owner, CBD", rating: 5 },
      { text: "Remote viewing works perfectly. I can see my house from my office phone thanks to Benevolent Security Services's CCTV setup.", name: "Simba Karonga", role: "Remote Monitoring Client", rating: 5 },
      { text: "Electric fence installation was done in one day with minimal disruption. Benevolent Security Services are efficient and tidy.", name: "Douglas Mhizha", role: "Homeowner", rating: 5 },
      { text: "The access control system Benevolent Security Services installed at our offices has completely eliminated unauthorised entry.", name: "Linda Masuku", role: "Corporate Client", rating: 5 },
      { text: "Night vision on these cameras is incredible. Benevolent Security Services recommended the right specs for our needs.", name: "Patrick Makoni", role: "Night Security Client", rating: 5 },
      ...
      { text: "Annual maintenance contract with Benevolent Security Services keeps everything working perfectly. Proactive, not reactive.", name: "Brian Mutema", role: "Maintenance Client", rating: 5 },
    ],
  },
  ...
  contact: {
    ...
    branches: [
      { name: "Main Office", address: "5th Floor, Pockets Building Angwa St, Jason Moyo Ave, Harare, Zimbabwe", phone: "+263 71 564 1827", email: "info@benevolentsecurity.co.zw" },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hello Benevolent! I need security services for my property.",
    backgroundImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1920&q=85",
  },

  footer: {
    description: "Benevolent Security Services provides comprehensive security solutions including CCTV, alarms, guarding, and consulting....",
    copyright: "Benevolent Security Services",
  },
};
